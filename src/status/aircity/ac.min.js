...
var LayerVisibleData = function (a, b) {
  ...
  CustomTagData = function (a, b, c, e, d, l, g) {
    this.id = a.toString();
    this.coordinate = b;
  ...
  if (this.colorProps)
    for (
      ...
      for (var d = $jscomp.makeIterator(b), l = d.next(); !l.done; l = d.next())
        (l = l.value), e.hasOwnProperty(l) && (e[l] = __convertColor(e[l]));
    }
  if (
    "Polygon" == this.type ||
    "Polygon3D" == this.type ||
    ...
    for (a = $jscomp.makeIterator(a), e = a.next(); !e.done; e = a.next())
      (b = e.value),
...
var CameraTourKeyFrame = function (a, b, c, e) {
    this.index = a;
    this.time = b;
    this.location = c;
    this.rotation = e;
    ...
    if ("object" == typeof b) {
      ...
      1 < arguments.length &&
        ...
        2 < arguments.length &&
          ...
          (d = arguments[2]),
        3 < arguments.length && (l = arguments[3]),
        4 < arguments.length && (g = arguments[4]);
    this.uniqueId = Date.now();
    (this.container = e ? document.getElementById(e) : null)
      ? (this.container &&
          ((this.observer = new (window.MutationObserver ||
            window.WebKitMutationObserver ||
            window.MozMutationObserver)(function (p) {
            c.onResize();
          })),
          ...
          g &&
            ((this.startupInfoPanelVisible = g), this.createStartupInfoPanel()),
      ...
      for (var c = 0; c < b.changedTouches.length; c++) {
        ...
        if (e.identifier === a.id) {
          this.emitMouseUp(
            ...
            e.clientX - this.parentClientRect.left,
            e.clientY - this.parentClientRect.top
          );
...
AirCityPlayer.prototype.setupWebRTCConnection = function () {
  ...
  this.pcClient.onicecandidate = function (b) {
    ...
    b.candidate &&
      ...
      (console.log(
        "-> SS: iceCandidate\n" + JSON.stringify(b.candidate, void 0, 4)
      ),
      this.ws.send(
...
AirCityPlayer.prototype.start = function () {
  this.delayStartTimerId = setTimeout(
    function () {
      ...
      this.observer = new (window.MutationObserver ||
        window.WebKitMutationObserver ||
        window.MozMutationObserver)(function (b) {
        a.onResize();
      });
      this.observer.observe(this.container, {
        attributes: !0,
...
/* eslint-enable */
export { AirCityPlayer, AirCityAPI };
