...
$jscomp.polyfill(
  ...
  function (a) {
    ...
    function e(k) {
      if (!$jscomp.owns(k, f)) {
        var l = new c();
        $jscomp.defineProperty(k, f, { value: l });
      }
    }
    function h(k) {
  ...
  function (a) {
    ...
    var e = function (g, k) {
        ...
        "object" == l || "function" == l
          ...
          : (l = "p_" + k);
        var n = g.data_[l];
        if (n && $jscomp.owns(g.data_, l))
          for (g = 0; g < n.length; g++) {
            var p = n[g];
            if ((k !== k && p.key !== p.key) || k === p.key)
              return { id: l, list: n, index: g, entry: p };
          }
      ...
      h = function (g, k) {
        ...
        return $jscomp.iteratorPrototype(function () {
          if (l) {
            for (; l.head != g.head_; ) l = l.previous;
            for (; l.next != l.head; )
  ...
  function (a) {
    ...
    e.prototype.resolveTo_ = function (f) {
      if (f === this)
        ...
        m ? this.resolveToNonPromiseObj_(f) : this.fulfill_(f);
      }
    };
    e.prototype.resolveToNonPromiseObj_ = function (f) {
      ...
      "function" == typeof m
        ? this.settleSameAsThenable_(m, f)
        : this.fulfill_(f);
    };
    ...
    e.prototype.settle_ = function (f, m) {
      if (0 != this.state_)
        throw Error(
          "Cannot settle(" +
            f +
    ...
    e.prototype.settleSameAsThenable_ = function (f, m) {
      var g = this.createResolveAndReject_();
      try {
        f.call(m, g.resolve, g.reject);
      } catch (k) {
        g.reject(k);
      }
    };
    e.prototype.then = function (f, m) {
      function g(p, q) {
      ...
      this.callWhenSettled_(g(f, k), g(m, l));
      return n;
    };
    e.prototype.catch = function (f) {
      return this.then(void 0, f);
    };
    e.prototype.callWhenSettled_ = function (f, m) {
      function g() {
        switch (k.state_) {
          case 1:
            f(k.result_);
    ...
    e.race = function (f) {
      return new e(function (m, g) {
        for (
          var k = $jscomp.makeIterator(f), l = k.next();
          !l.done;
          l = k.next()
        )
          c(l.value).callWhenSettled_(m, g);
      });
    };
    e.all = function (f) {
      var m = $jscomp.makeIterator(f),
        g = m.next();
      return g.done
        ? c([])
        : new e(function (k, l) {
            ...
            do
              p.push(void 0),
                q++,
                c(g.value).callWhenSettled_(n(p.length - 1), l),
                (g = m.next());
            while (!g.done);
          });
    };
  ...
  if (void 0 != a) {
    ...
    if (/^(rgb|RGB)/.test(a)) {
      ...
      if (/^#[0-9A-F]{3}$/i.test(a)) {
        var d = "#";
        a.replace(/[0-9A-F]/gi, function (e) {
          d += e + e;
        });
        a = d;
      }
      /^#[0-9A-F]{6}$/i.test(a) &&
        a.replace(/[0-9A-F]{2}/gi, function (e) {
          e = eval("0x" + e);
          b.push(Number((e / 255).toFixed(1)));
        });
...
function __getArrayDimenstion(a) {
  function b(c, d) {
    return c.reduce(function (e, h) {
      var f;
      Array.isArray(h) && (f = b(h, d + 1));
      return f > e ? f : e;
    }, d);
  }
  return b(a, 1);
...
var LayerVisibleData = function (a, b) {
  ...
  HeatMapPointData = function (a, b, c, d) {
    this.id = a.toString();
    this.coordinate = b;
    this.radius = c;
    this.heatValue = d;
  },
  TagData = function (a, b, c, d, e, h, f, m, g, k, l, n, p, q) {
    this.id = a.toString();
    this.coordinate = b;
    this.imagePath = c;
    this.imageSize = d;
    ...
    this.range = f || [1, 1e5];
    this.showLine = !!m;
    this.textColor = g || [0, 0, 0, 1];
    this.textBackgroundColor = k || [1, 1, 1, 0.85];
    this.textBorderColor = l || [0, 0, 0, 0];
    this.textRange = n || 1e5;
    this.hoverImagePath = p;
    this.autoHidePopupWindow = q || !0;
  },
  ...
  CustomTagData = function (a, b, c, d, e, h, f) {
    this.id = a.toString();
    this.coordinate = b;
    this.contentURL = c.url;
    this.contentSize = [c.width, c.height];
    this.popupURL = d.url;
    this.popupSize = [d.width, d.height];
    this.pivot = e;
    this.range = h;
    this.autoHidePopupWindow = f || !0;
  },
  HighlightAreaData = function (a, b, c, d, e, h) {
    this.id = a.toString();
  ...
  ImageButtonData = function (a, b, c, d, e, h, f, m) {
    this.id = a.toString();
    this.x = b;
    this.y = c;
    this.width = d;
  ...
  AnimatedImageButtonData = function (a, b, c, d, e, h, f, m, g) {
    this.id = a.toString();
    this.x = b;
    this.y = c;
    this.width = d;
    ...
    this.imageSequeceLength = f;
    this.loop = !!m;
    this.interactable = !!g;
  },
  BeamData = function (a, b, c, d, e, h, f) {
    this.id = a.toString();
    this.duration = b;
    this.thickness = c;
    this.interval = d;
  ...
  RadiationPointData = function (a, b, c, d, e, h) {
    this.id = a.toString();
    this.coordinate = b;
    this.radius = c;
    this.rippleNumber = d;
  ...
  Polygon3DData = function (a, b, c, d, e, h, f, m) {
    this.id = a.toString();
    this.style = b;
  ...
  PolylineData = function (a, b, c, d, e, h, f, m, g, k) {
    this.id = a.toString();
    this.color = __convertColor(b);
    this.coordinates = c;
    this.style = void 0 == d ? 0 : d;
    this.thickness = void 0 == e ? 20 : e;
    this.brightness = void 0 == h ? 0.5 : h;
    this.flowRate = void 0 == f ? 0.5 : f;
    this.tiling = m || 0;
    this.depthTest = g || !0;
    this.shape = void 0 == k ? 0 : k;
  },
  ODLineData = function (a, b, c, d, e, h, f, m, g, k, l, n, p, q, r, t, u) {
    this.id = a.toString();
    this.color = __convertColor(b);
    this.coordinates = c;
    this.flowRate = void 0 == d ? 0.5 : d;
    this.brightness = void 0 == e ? 0.5 : e;
    this.bendDegree = void 0 == h ? 0.5 : h;
    this.tiling = f || 0;
    this.lineThickness = void 0 == m ? 20 : m;
    this.flowPointSizeScale = void 0 == g ? 20 : g;
    this.labelSizeScale = void 0 == k ? 100 : k;
    this.lineShape = void 0 == l ? 1 : l;
    this.lineStyle = n || 0;
    this.flowShape = p || 0;
    this.startPointShape = q || 0;
    this.endPointShape = r || 0;
    this.startLabelShape = t || 0;
    this.endLabelShape = u || 0;
    this.endLabelStyle =
  ...
  PolygonData = function (a, b, c, d, e, h, f, m) {
    this.id = a.toString();
    this.color = __convertColor(b);
    this.coordinates = __convertCoordinatesForParts(c);
    this.framecolor = __convertColor(d);
    this.framethickness = e;
    this.depthTest = h || !0;
    this.brightness = f;
    this.style = m;
  },
  PanoramaData = function (a, b, c, d, e, h) {
    this.id = a.toString();
    this.imagePath = b;
    this.coordinate = c;
    this.yaw = d;
  ...
  DecalData = function (a, b, c, d, e, h, f, m) {
    this.id = a.toString();
    this.order = b;
    this.texturePath = c;
    this.location = d;
  ...
  TileLayerData = function (a, b, c, d, e) {
    this.id = a.toString();
    this.fileName = b;
    this.location = c;
    this.rotation = d;
  ...
  CustomObjectData = function (a, b, c, d, e, h, f) {
    this.id = a;
    this.pakFilePath = b;
    this.assetPath = c;
    this.location = d;
  ...
  CustomObjectData2 = function (a, b, c, d, e, h, f) {
    this.id = a;
    this.tileLayerId = b;
    this.objectId = c;
    this.location = d;
  ...
  VideoProjectionData = function (a, b, c, d, e, h, f) {
    this.id = a;
    this.videoURL = b;
    this.location = c;
    this.rotation = d;
  ...
  BPFunctionData = function (a, b, c, d, e) {
    this.actorTag = a;
    this.objectName = b;
    this.functionName = c;
    this.paramType = d;
  ...
  ViewshedData = function (a, b, c, d, e, h, f) {
    this.id = a.toString();
    this.coordinate = b;
    this.fov = c;
    this.radius = d;
  ...
  DynamicWaterData = function (a, b, c, d, e) {
    this.id = a;
    this.coordinates = __convertCoordinatesForParts(b);
    this.style = c;
    this.groupId = d;
...
AirCityAPI.prototype.call = function (a, b) {
  var c = this;
  if (this.webSocket && 1 != this.webSocket.readyState)
    return (
  ...
  var d = a.command + "_" + a.callbackIndex;
  b && (this.callbackMap[d] = b);
...
AirCityAPI.prototype.onConnectionMessage = function (a) {
  ...
  if (c) {
    var d = b.versionType || "*";
    this.misc.apiVersionServer = d + "." + c;
    ...
    if (this.onApiVersionReceived) this.onApiVersionReceived(d, c);
  }
  b.command
...
AirCityAPI.Camera.prototype.set = function (a, b, c, d, e, h, f) {
  ...
  "function" == typeof h && ((f = h), (h = void 0));
...
AirCityAPI.Camera.prototype.lookAt = function (a, b, c, d, e, h, f, m) {
...
AirCityAPI.Camera.prototype.lookAtBBox = function (a, b, c, d, e) {
...
AirCityAPI.Object.prototype._processProps = function (a) {
  ...
  if (this.colorProps)
    for (
      ...
      d = d.value;
      for (var e = $jscomp.makeIterator(b), h = e.next(); !h.done; h = e.next())
        (h = h.value), d.hasOwnProperty(h) && (d[h] = __convertColor(d[h]));
    }
  if (
    "Polygon" == this.type ||
    "Polygon3D" == this.type ||
    ...
    for (a = $jscomp.makeIterator(a), d = a.next(); !d.done; d = a.next())
      (b = d.value),
...
AirCityAPI.Object.prototype._focus = function (a, b, c, d) {
...
AirCityAPI.Object.prototype._updateOneProp = function (a, b, c, d) {
  if (this._useBatchUpdate) {
    d = !1;
    for (
      var e = $jscomp.makeIterator(this._tempUpdateData), h = e.next();
      !h.done;
      h = e.next()
    )
      if (((h = h.value), h.id == a.toString())) {
        d = !0;
        h[b] = c;
        break;
      }
    d ||
      ...
      (d.id = a.toString()),
      (d[b] = c),
      this._tempUpdateData.push(d));
  } else return (e = {}), (e.id = a.toString()), (e[b] = c), this.update(e, d);
};
...
var CameraTourKeyFrame = function (a, b, c, d) {
    this.index = a;
    this.time = b;
    this.location = c;
    this.rotation = d;
...
AirCityAPI.CameraTour.prototype.setName = function (a, b) {
  return AirCityAPI.Object.prototype._updateOneProp.call(this, "name", a, b);
};
...
AirCityAPI.TileLayer.prototype.focus = function (a, b, c, d) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, d);
};
...
AirCityAPI.TileLayer.prototype.stopHighlightActor = function (a, b, c) {
  var d = void 0 == a;
  "function" == typeof a && ((c = a), (d = !0));
  if (d) return this.stopHighlightActors(c);
  a = new TileLayerActorData(a, b);
...
AirCityAPI.TileLayer.prototype.setCollision = function (a, b, c) {
  ...
  for (var e = a.next(); !e.done; e = a.next())
    d.push({ id: e.value, enableCollision: b });
  return this.int.call(
    { command: CommandType.TileLayer_SetCollision, data: d },
    c
  );
};
AirCityAPI.TileLayer.prototype.addModifier = function (a, b, c, d, e) {
  return this.int.call(
    {
...
AirCityAPI.TileLayer.prototype.updateModifier = function (a, b, c, d, e) {
  return this.int.call(
    {
...
AirCityAPI.TileLayer.prototype.clearModifier = function (a) {
  return this.int.call0(CommandType.TileLayer_Modifier_Clear, a);
};
...
AirCityAPI.HeatMap.prototype.add = function (a, b, c, d, e) {
    ...
    ? this.int.call(
        {
          ...
          bbox: b,
          range: c,
          data: this.int.makeArray(d),
        },
        e
      )
    : (this.int.logWithColor("red", "Invalid bbox value"), !1);
};
AirCityAPI.HeatMap.prototype.update = function (a, b, c, d, e) {
  ...
  c && (a.range = c);
  d && (a.data = this.int.makeArray(d));
  return this.int.call(a, e);
};
...
AirCityAPI.HeatMap.prototype.focus = function (a, b, c, d) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, d);
};
...
AirCityAPI.Beam.prototype.focus = function (a, b, c, d) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, d);
};
...
AirCityAPI.HighlightArea.prototype.focus = function (a, b, c, d) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, d);
};
...
AirCityAPI.CustomObject.prototype.focus = function (a, b, c, d) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, d);
};
...
AirCityAPI.CustomObject.prototype.callFunction = function (a, b, c, d, e) {
  return this.int.call(
    {
...
AirCityAPI.Viewshed.prototype.focus = function (a, b, c, d) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, d);
};
...
AirCityAPI.DynamicWater.prototype.focus = function (a, b, c, d) {
  return AirCityAPI.Object.prototype._focus.call(this, a, b, c, d);
};
...
AirCityAPI.Misc.prototype.setDateTime = function (a, b, c, d, e, h, f, m) {
  return this.int.call(
    {
...
AirCityAPI.Misc.prototype.setCampassVisible = function (a, b) {
  return this.int.call(
    { command: CommandType.Misc_SetCampassVisible, visible: a },
    b
  );
};
AirCityAPI.Misc.prototype.setQueryToolState = function (a, b) {
  return this.int.call(
    { command: CommandType.Misc_SetMousePickMask, mouseClick: a },
    b
  );
};
AirCityAPI.Misc.prototype.setMousePickMask = function (a, b) {
  ...
  a & MousePickMask.MouseMove && (d = !0);
  a & MousePickMask.MouseHover && (e = !0);
  return this.int.call(
    {
      command: CommandType.Misc_SetMousePickMask,
      mouseClick: c,
      mouseMove: d,
      mouseHover: e,
    },
...
AirCityAPI.Misc.prototype.playVideo = function (a, b, c, d, e, h, f) {
  return this.int.call(
    {
      command: CommandType.Misc_PlayVideo,
      data: [{ id: a.toString(), position: [b, c], size: [d, e], url: h }],
    },
    f
  );
};
...
AirCityAPI.Misc.prototype.startPolygonClip = function (a, b) {
  return this.int.tools.startPolygonClip(a, b);
};
...
AirCityAPI.Tools.prototype.startPlaneClip = function (a, b, c) {
  return this.int.call(
    { command: CommandType.Tools_StartPlaneClip, location: a, rotation: b },
    c
  );
};
AirCityAPI.Tools.prototype.startVolumeClip = function (a, b, c) {
  return this.int.call(
    { command: CommandType.Tools_StartVolumeClip, location: a, value: b },
    c
  );
};
...
AirCityAPI.Tools.prototype.startSkylineAnalysis = function (a, b) {
  ...
  if (a.tileLayers) {
    ...
    for (
      var c = $jscomp.makeIterator(a.tileLayers), d = c.next();
      !d.done;
      d = c.next()
    )
      (d = d.value),
        d.hasOwnProperty("color") && (d.color = __convertColor(d.color));
  }
...
AirCityAPI.Tools.prototype.exportSkyline = function (a, b, c, d) {
  ...
  if (c.tileLayers) {
    ...
    for (
      var e = $jscomp.makeIterator(c.tileLayer), h = e.next();
      !h.done;
      h = e.next()
    )
      (h = h.value),
        h.hasOwnProperty("color") && (h.color = __convertColor(h.color));
  }
  return this.int.call(
    {
...
AirCityAPI.Weather.prototype.setDateTime = function (a, b, c, d, e, h, f) {
  return this.int.call(
    {
...
AirCityAPI.Weather.prototype.setSnowParam = function (a, b, c, d) {
  return this.int.call(
    {
      command: CommandType.Weather_SetParams,
      rainsnow: 1,
...
AirCityAPI.Weather.prototype.setFogParam = function (a, b, c, d) {
  return this.int.call(
    {
      command: CommandType.Weather_SetParams,
      fogDensity: a,
...
AirCityAPI.EditHelper.prototype.setParam = function (a, b, c, d, e, h) {
  return this.int.call(
    {
